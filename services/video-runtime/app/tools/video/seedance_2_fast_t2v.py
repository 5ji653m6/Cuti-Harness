...
Speed-optimized pure text-to-video, faster and cheaper than standard Seedance 2.0 T2V. Supports optional reference_images /
reference_videos / reference_audios as style/character/audio references.
